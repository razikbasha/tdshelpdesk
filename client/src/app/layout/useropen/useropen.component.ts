...
@Component({
  selector: 'app-useropen',
  templateUrl: './useropen.component.html',
  styleUrls: ['./useropen.component.css']
})
export class UseropenComponent implements OnInit {
...
idd;
  ...
  constructor(private router: Router,
    ...
    console.log(uid);
      ...
      this.auservice.getAlluseropen(uid).subscribe(tickets => { 
      console.log(tickets);
