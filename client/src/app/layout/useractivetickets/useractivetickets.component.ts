...
@Component({
  selector: 'app-useractivetickets',
  templateUrl: './useractivetickets.component.html',
  styleUrls: ['./useractivetickets.component.css']
})
export class UseractiveticketsComponent implements OnInit {
...
idd;
  ...
  constructor(private router: Router,
    ...
    console.log(uid);
      ...
      this.auservice.getUserTickets(uid).subscribe(tickets => { 
      console.log(tickets);
