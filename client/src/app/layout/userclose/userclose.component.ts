...
@Component({
  selector: 'app-userclose',
  templateUrl: './userclose.component.html',
  styleUrls: ['./userclose.component.css']
})
export class UsercloseComponent implements OnInit {
...
idd;
  ...
  constructor(private router: Router,
    ...
    console.log(uid);
      ...
      this.auservice.getAlluserclose(uid).subscribe(tickets => { 
      console.log(tickets);
